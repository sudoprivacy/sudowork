...
# Windows x64
touch "$ARTIFACTS_DIR/windows-build-x64/Sudowork-1.0.0-win-x64.exe"
touch "$ARTIFACTS_DIR/windows-build-x64/Sudowork-1.0.0-win-x64.exe.blockmap"
...
# Windows arm64
touch "$ARTIFACTS_DIR/windows-build-arm64/Sudowork-1.0.0-win-arm64.exe"
touch "$ARTIFACTS_DIR/windows-build-arm64/Sudowork-1.0.0-win-arm64.exe.blockmap"
