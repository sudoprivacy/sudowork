  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        relationType: { type: 'string', enum: ['object_property', 'symmetric_property', 'transitive_property', 'functional_property'] },
        semanticType: { type: 'string', enum: ['composition', 'event', 'inheritance', 'dependency', 'association'] },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        code: { type: 'string' },
        name: { type: 'string' },
        expression: { type: 'string', description: 'Free-form expression, e.g. `age > 0` or `not_null(email)`.' },
