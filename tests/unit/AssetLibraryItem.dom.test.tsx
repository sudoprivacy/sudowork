...
describe('AssetLibraryItem', () => {
  ...
  it('shows grouped actions', async () => {
    ...
    render(<AssetLibraryItem entry={entry} onOpenConversation={onOpenConversation} onMissing={vi.fn()} />);
  ...
  it('does not render when the file is missing', async () => {
    ...
    render(<AssetLibraryItem entry={entry} onOpenConversation={vi.fn()} onMissing={onMissing} />);
