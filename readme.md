...
**Sudowork is more than a chat client.** It's a Cowork platform where AI agents work alongside you on your computer — reading files, writing code, browsing the web, and automating tasks. You see everything the agent does, and you're always in control.

|                                 | Traditional AI Chat Clients | **Sudowork (Cowork)**                                                                          |
| :------------------------------ | :-------------------------- | :------------------------------------------------------------------------------------------- |
...
Other AI apps give you a chatbox with your API key. **Sudowork gives you a full Cowork agent.**
...
Sudowork includes **12 professional assistants** with predefined capabilities, extendable through custom skills:
...
_Your 24/7 AI assistant — access Sudowork from any device, anywhere._
...
## 🤔 Why Choose Sudowork Over Claude Cowork?
...
Sudowork is a **free and open-source Multi-AI Agent Desktop**. Compared to Claude Cowork which only runs on macOS and is locked to Claude, Sudowork is its full-model, cross-platform enhanced version.

| Dimension     | Claude Cowork | Sudowork                                           |
| :------------ | :------------ | :----------------------------------------------- |
...
A: Sudowork is completely free and open source. You can sign in with Google to use Gemini for free, or use API keys from any provider you prefer.
</details>
