...
// Pure storage/config/model/MCP type surface, extracted from
// apps/desktop/src/common/storage.ts so the renderer (and a future shared
// renderer package) can consume these types without importing the
