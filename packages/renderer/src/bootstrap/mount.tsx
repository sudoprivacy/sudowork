...
/**
 * Mount the shared renderer into #root. Transport-agnostic: the hosting app must
 * have already wired a `bridge.adapter` transport (electron on desktop, moss on
 * web) before calling this — see wireElectronTransport / the web moss adapter.
 */
