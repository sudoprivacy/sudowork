...
import type { IInstalledSkillInfo, IAssistantHubSkill, ISkillHubSkill } from '@sudowork/host-bridge/ipcBridge';
import { assistantHub } from '@sudowork/host-bridge/ipcBridge';
