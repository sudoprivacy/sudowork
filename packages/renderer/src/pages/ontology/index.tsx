...
export default function OntologyPage() {
  ...
  const api = useMemo<IOntologyWorkbenchApi>(
    () => ({
      ...
      executeLogicFunction: async (input) => unwrap(await ipcBridge.ontology.executeLogicFunction.invoke(input), t('ontology.errors.operationFailed')),
      executeRelation: async (input) => unwrap(await ipcBridge.ontology.executeRelation.invoke(input), t('ontology.errors.operationFailed')),
      executeAction: async (input) => unwrap(await ipcBridge.ontology.executeAction.invoke(input), t('ontology.errors.operationFailed')),
