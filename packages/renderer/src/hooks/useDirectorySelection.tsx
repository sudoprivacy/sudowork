...
// WebUI-mode file/directory open request event. Mirrors the shared
// 'show-open-request' protocol the host adapter emits; kept local so the
// renderer package stays decoupled from the desktop app's adapter module.
const SHOW_OPEN_REQUEST_EVENT = 'show-open-request';
