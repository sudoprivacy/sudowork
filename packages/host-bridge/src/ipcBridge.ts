...
export const ontology = {
  ...
  importFiles: bridge.buildProvider<IBridgeResponse<{ snapshot: IOntologyWorkbenchSnapshot; files: IOntologyImportedFile[] }>, IOntologyImportFilesInput>('ontology.assets.import-files'),
  ...
  publishCurrentDraft: bridge.buildProvider<IBridgeResponse<{ snapshot: IOntologyWorkbenchSnapshot; version: IOntologyPublishedVersion }>, IOntologySelectWorkbenchInput | undefined>('ontology.publish.current-draft'),
  ...
  createAgentBlueprint: bridge.buildProvider<IBridgeResponse<{ snapshot: IOntologyWorkbenchSnapshot; blueprint: IOntologyAgentBlueprint }>, IOntologyAgentBlueprintInput>('ontology.agent.create-blueprint'),
  registerAgentBlueprint: bridge.buildProvider<IBridgeResponse<{ snapshot: IOntologyWorkbenchSnapshot; blueprint: IOntologyAgentBlueprint }>, IOntologyRegisterAgentInput>('ontology.agent.register-blueprint'),
