  ...
  const header = {
    render: () => (
      <div className='flex items-center justify-between w-full pb-20px border-b border-[var(--bg-3)]'>
        <h3 className='text-16px font-600 text-foreground m-0'>{t('settings.productImprovement.dialogTitle', '产品体验改进计划')}</h3>
        <button onClick={handleCancel} className='w-32px h-32px f-center rd-8px transition-colors cursor-pointer border-0 bg-transparent p-0 hover:bg-2 focus:outline-none' aria-label='Close'>
