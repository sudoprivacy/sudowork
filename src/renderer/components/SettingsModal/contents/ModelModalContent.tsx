...
import { isNewApiPlatform, NEW_API_PROTOCOL_OPTIONS } from '@/renderer/utils/modelPlatforms';
    ...
    <div className='flex flex-col bg-2 rd-16px px-16px md:px-24px lg:px-28px py-16px md:py-18px'>
      ...
      <div className='flex-shrink-0 border-b border-[var(--color-border-2)] pb-12px mb-14px flex items-center justify-between gap-8px flex-wrap'>
        ...
        <div className='flex items-center gap-8px flex-wrap'>
          <Button type='outline' shape='round' size='small' onClick={clearAllHealthData} className='rd-100px h-34px px-14px'>
            {t('settings.clearStatus')}
          </Button>
          <Button type='outline' shape='round' icon={<Plus size='16' />} onClick={() => addPlatformModalCtrl.open()} className='rd-100px h-34px px-14px'>
            {t('settings.addModel')}
          </Button>
        </div>
      </div>
