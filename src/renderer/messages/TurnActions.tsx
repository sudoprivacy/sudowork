      ...
      <div className='flex items-center min-h-28px gap-4px flex-wrap'>
        ...
        {showTokenUsageBadge && totalTokens && (
          <Tooltip content={usageTooltip}>
            <div className='ml-4px max-w-full truncate text-11px leading-18px px-6px py-1px rd-4px border border-solid border-[var(--color-border-2)] text-secondary bg-[var(--color-fill-1)]'>
