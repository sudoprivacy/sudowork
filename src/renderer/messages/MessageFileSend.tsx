  ...
  if (fileType === 'image') {
    return (
      <div className='w-full'>
        <div className='flex items-center gap-2 rounded-md bg-muted px-3 py-2' {...clickableProps}>
          <Picture size={18} className='flex-shrink-0 text-foreground-secondary' />
          <span className='text-13px text-foreground-secondary'>{fileName}</span>
        </div>
      </div>
    );
  }
    ...
    <div className='w-full'>
      <div className='flex items-center gap-2 rounded-md bg-muted px-3 py-2' {...clickableProps}>
        ...
        <div className='flex flex-col gap-2px'>
          ...
          <span className='text-12px text-foreground-tertiary'>{typeLabel}</span>
        </div>
      </div>
    </div>
  );
