...
const HOC = <HOCProps extends object>(HOCComponent: React.FC<PropsWithChildren<HOCProps>>, hocProps?: Partial<HOCProps>) => {
...
const Create = <HOCProps extends object>(HOCComponent: React.FC<HOCProps>, hocProps?: Partial<HOCProps>): React.FC<HOCProps> => {
