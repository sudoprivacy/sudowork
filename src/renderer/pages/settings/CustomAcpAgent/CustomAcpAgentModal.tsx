                ...
                {detectedAgents.map((detectedAgent) => {
                  ...
                  return (
                    <div
                      ...
                      className={`p-2.5 rounded-lg cursor-pointer transition-all flex items-center gap-2 relative border ${isSelected ? 'bg-fill-2 border-primary' : 'bg-2 border-transparent hover:bg-fill-2 hover:border-light'}`}
