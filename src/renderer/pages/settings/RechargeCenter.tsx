...
const RechargeCenter: React.FC = () => {
  ...
  }, [currentUser?.token, selectedPackage, paymentMethod, fetchWithAuth, t]);
  ...
  const startPolling = useCallback(
    ...
    [currentUser?.token, t, refresh, fetchStats]
  );
    ...
    <SettingsPageWrapper contentClassName='max-w-800px'>
      <div className='flex flex-col gap-24px py-8px'>
        ...
        {statsLoading ? (
          ...
          <PointsDashboard remainingPoints={remainingPoints} usedPoints={usedPoints} bonusPoints={bonusPoints} />
        )}
