...
const PANEL_CLASS = 'flex flex-col gap-2px p-6px rd-12px border border-solid border-[var(--border-default)] bg-popup max-h-[min(60vh,420px)] overflow-y-auto scrollbar-hide';
