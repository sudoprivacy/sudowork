...
const ChatConversation: React.FC<{
  ...
  // Workspace panel is enabled if the conversation supports workspaces (for gemini, always true; for others, depends on workspace existence)
  const workspaceEnabled = conversation?.type === 'gemini' || Boolean(conversation?.extra?.workspace);
