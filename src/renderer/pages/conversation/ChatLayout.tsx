              ...
              {isPreviewOpen ? (
                ...
                >
                  <div className='bg-background! h-full overflow-hidden'>
                    <div
                      className={`preview-panel flex h-full flex-col py-1.5 pr-3 pl-2 relative [-webkit-app-region:no-drag] ${isLinuxRuntime ? 'z-9' : 'z-11'} ${isPreviewFullscreen && isMacRuntime && layout?.siderCollapsed ? 'pointer-events-none' : ''}`}
                      style={{ paddingTop: isLinuxRuntime ? 28 : undefined }}
                    >
