...
const SelectionToolbar: React.FC<SelectionToolbarProps> = ({ selectedText, position, onClear }) => {
  ...
  return (
    <div ref={refs.setFloating} style={{ ...floatingStyles, zIndex: 99999 }}>
      <div className='flex items-center px-12px py-8px bg-popover rd-8px shadow-lg border border-solid border-border cursor-pointer hover:opacity-80 transition-opacity' onMouseDown={handleMouseDown}>
