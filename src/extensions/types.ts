...
export const ExtensionMetaSchema = z
  .object({
    ...
    /** P2: Sudowork core version compatibility */
    engine: z
      .object({
        sudowork: z
          .string()
          ...
          .optional()
          .describe('Compatible Sudowork core version range'),
      })
      .optional(),
    /**
...
export const PRESET_AGENT_TYPES = ['scode', 'codebuddy', 'opencode', 'qwen'] as const;
