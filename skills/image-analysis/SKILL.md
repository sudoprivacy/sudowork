...
The script reads API credentials and model from `sudocode.json` (`~/.nexus/sudocode/sudocode.json`, or `SUDOCODE_CONFIG_PATH`). No manual env var configuration is needed.
