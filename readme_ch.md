<p align="center">
  <img src="./resources/sudowork-banner-1.png" alt="Sudowork - Cowork with AI Agents" width="100%">
</p>
...
**Sudowork 不只是个聊天工具。** 它是一个真正的 Cowork 平台，AI Agent 就像您的得力助手，在电脑上帮您处理各种任务——读文件、写代码、查资料、自动化工作流。Agent 的一举一动都在您的掌控之中，透明可见。

|                       | 传统 AI 聊天客户端 | **Sudowork (Cowork)**                                                        |
| :-------------------- | :----------------- | :------------------------------------------------------------------------- |
...
Sudowork 自带完整的 AI Agent。不像其他工具需要你手动安装各种 CLI 工具，**Sudowork 装好就能用，开箱即用**。
...
其他 AI 应用可能只给你个聊天窗口，**但 Sudowork 给你的是完整的 Cowork Agent**。
...
Sudowork 内置 **12 个专业助手**，每个都有独特能力，还能通过自定义技能继续扩展：
...
> **设置：** Sudowork 设置 → WebUI 设置 → Channel，配置 Bot Token。
parameter>
...
> [远程互联网访问教程](https://github.com/iOfficeAI/Sudowork/wiki/Remote-Internet-Access-Guide-Chinese)
...
> [图像生成模型配置指南](https://github.com/iOfficeAI/Sudowork/wiki/Sudowork-Image-Generation-Tool-Model-Configuration-Guide)
...
## 🤔 为什么选择 Sudowork 而非 Claude Cowork？
...
Sudowork 是一个**免费开源的 Multi-AI Agent 桌面应用**。相比只能在 macOS 上用、还只能绑定 Claude 的 Claude Cowork，Sudowork 支持全模型、跨平台，是它的全面升级版。

| 维度     | Claude Cowork | Sudowork                                        |
| :------- | :------------ | :-------------------------------------------- |
...
答：Sudowork 完全免费且开源。你可以用 Google 登录免费使用 Gemini，或者用任何你喜欢的 API 密钥。
</details>
...
- [📖 完整安装指南](https://github.com/iOfficeAI/Sudowork/wiki/Getting-Started) — 从下载到配置，一步步教你
- [⚙️ LLM 配置指南](https://github.com/iOfficeAI/Sudowork/wiki/LLM-Configuration) — 多平台 AI 模型怎么配置
- [🤖 多 Agent 模式设置](https://github.com/iOfficeAI/Sudowork/wiki/ACP-Setup) — 把终端 AI Agent 集成进来
- [🔌 MCP 工具配置](https://github.com/iOfficeAI/Sudowork/wiki/MCP-Configuration-Guide) — 模型上下文协议服务器设置
- [🌐 WebUI 配置指南](https://github.com/iOfficeAI/Sudowork/wiki/WebUI-Configuration-Guide) — WebUI 完整设置教程

**🎯 使用场景**

- [📁 文件管理](https://github.com/iOfficeAI/Sudowork/wiki/file-management) — 让 AI 帮你整理文件
- [📊 Excel 处理](https://github.com/iOfficeAI/Sudowork/wiki/excel-processing) — AI 驱动的数据处理
- [🎨 图像生成](https://github.com/iOfficeAI/Sudowork/wiki/Sudowork-Image-Generation-Tool-Model-Configuration-Guide) — AI 图像生成
- [📚 更多使用场景](https://github.com/iOfficeAI/Sudowork/wiki/Use-Cases-Overview)

**❓ 支持与帮助**

- [❓ FAQ](https://github.com/iOfficeAI/Sudowork/wiki/FAQ) — 常见问题和解决方案
- [🔧 配置与使用教程](https://github.com/iOfficeAI/Sudowork/wiki/Configuration-Guides) — 完整配置文档
...
- [GitHub Discussions](https://github.com/iOfficeAI/Sudowork/discussions) — 分享想法，交流使用技巧
- [报告问题](https://github.com/iOfficeAI/Sudowork/issues) — 遇到 bug 或有新功能想法？告诉我们
- [发布更新](https://github.com/iOfficeAI/Sudowork/releases) — 获取最新版本
...
<p align="center">
  <a href="https://www.star-history.com/#iOfficeAI/sudowork&Date" target="_blank">
    <img src="https://api.star-history.com/svg?repos=iOfficeAI/sudowork&type=Date" alt="Star History" width="600">
  </a>
</p>
...
[报告 Bug](https://github.com/iOfficeAI/Sudowork/issues) · [请求功能](https://github.com/iOfficeAI/Sudowork/issues)
